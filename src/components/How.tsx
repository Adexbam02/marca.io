...
export default function How() {
  ...
  return (
    <section
      className={`px-[1rem] md:px-[9rem] pt-14 py-[0rem] md:py-[1rem] flex items-center justify-center flex-col gap-10 md:gap-4 md:grid grid-rows-2 grid-flow-col md:items-start`}
    >
