...
export default function PricingCard({ who, price, color, textColor, priceValText }: Pricing) {
  return (
    <div
      className={`${color} flex flex-col items-center justify-center gap-4 p-[30px] rounded-md mb-4 shadow-xl`}
    >
      ...
      <div className={`flex flex-col gap-2 items-start ${priceValText} font-medium`}>
        <PriceVal text="Feedback Categorization" />
        <PriceVal text="Feedback Categorization" />
        <PriceVal text="Feedback Categorization" />
        <PriceVal text="Feedback Categorization" />
        <PriceVal text="Feedback Categorization" />
